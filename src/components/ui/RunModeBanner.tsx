...
// bare: strip this banner's own border/background/padding so it can be
...
export function RunModeBanner({ compact = false, bare = false }: { compact?: boolean; bare?: boolean }) {
  ...
  if (!offline) {
    return (
      <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "#15803d", ...(bare ? {} : { background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 8, padding: compact ? "5px 10px" : "7px 11px" }) }}>
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", fontSize: 12, color: "#92400e", ...(bare ? {} : { background: "#fffbeb", border: "1px solid #fde68a", borderRadius: 8, padding: compact ? "5px 10px" : "7px 11px" }) }}>
