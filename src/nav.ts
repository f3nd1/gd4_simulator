...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { path: "/checklist-library", label: "Audit Checklist Library", hint: "The specialist checks, red flags and expected evidence the AI applies per criterion — view, edit, add and import/export them" },
