...
// Real findings carried over from the April 2026 internal mock audit.
...
const RAW_AFIS: RawAFI[] = [
  ...
  ["B9", "4.4.1", "Refund PPD misaligned with Student Contract clause 3.8; computation communication not documented.", "AFI", "High"],
  ...
  ["B16", "5.4.1", "PPD does not document non-academic progress reports, AEIS parent reporting, intervention evaluation.", "AFI", "Medium"],
  ["B17", "5.5.1", "PPD does not document appointment of vetting personnel or assessment-plan review.", "AFI", "High"],
  ["B18", "5.5.1", "Grading criteria for the Diploma project/report assessment not established.", "AFI", "Critical"],
  ["B19", "6.2.1", "17 of 19 Management Review 2025 follow-up actions lack execution timelines.", "AFI", "High"],
