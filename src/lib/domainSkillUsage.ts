...
export const DOMAIN_SKILL_CONSUMERS: DomainSkillConsumer[] = [
  ...
  { fn: "runLiveChecklistGeneration", file: "src/lib/ai/agentRuntime.ts", surface: "Sub-Criterion Checklist → Suggest / Generate & add checklist lines" },
  ...
  { fn: "runLiveGroupedFindingWriter", file: "src/lib/ai/findingWriter.ts", surface: "Findings → Draft grouped findings (AI)" },
  { fn: "runLiveClosureDraft", file: "src/lib/ai/agentRuntime.ts", surface: "Quality Action / AFI → Draft root cause & actions (AI)" },
  { fn: "runLiveClosureReview", file: "src/lib/ai/agentRuntime.ts", surface: "Quality Action / AFI → Check this closure is sound (AI)" },
