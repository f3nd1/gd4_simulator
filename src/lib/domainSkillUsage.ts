...
export const DOMAIN_SKILL_CONSUMERS: DomainSkillConsumer[] = [
  ...
  { fn: "runLiveChecklistGeneration", file: "src/lib/ai/agentRuntime.ts", surface: "Sub-Criterion Checklist → AI first pass (generate lines)" },
  { fn: "runHolisticBandSuggestion", file: "src/lib/ai/agentRuntime.ts", surface: "Sub-Criterion Checklist → AI first pass (suggest APSR scores)" },
