                      ...
                      <button
                        ...
                        title={noAuditors ? MSG_NO_AUDITORS_EXIST
                          : auditMode === "hybrid" && autoScoreBands
                            ? tip("Runs this ONE sub-criterion end to end and AI-scores its band (labelled 'Band set automatically'): verdicts, compile findings, Outcomes & Review, band — no mid-run pause. Review it afterwards on the Final Report. No other sub-criterion is touched.")
